...
Lgxg, Le = simulate_Cholesky_from_std_sparse(SNP , s2gxg, s2e, stability=1e-8, density=density)  
_, y = simulate_from_raw_only_W_remove_sampling_err(SNP , Lgxg, Le, s2gxg, s2e)


output_dir = f"/home/ziyanzha/MOM_within_gene/Stored_data/phenotype/STD_y_{mode}_n{n}_m{m}_density{density}"
