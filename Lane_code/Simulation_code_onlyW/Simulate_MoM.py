...
y_path = f"/home/ziyanzha/MOM_within_gene/Only_W_model/Phenotype/y_{mode}_n{n}_m{m}_s2gxg{s2gxg}_s2e{s2e}/rep{rep}.csv"
...
output_dir = f"/home/ziyanzha/MOM_within_gene/Only_W_model/result/{mode}_n{n}m{m}_s2gxg{s2gxg}_s2e{s2e}"
