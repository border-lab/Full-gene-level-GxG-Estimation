...
y_path = f"/home/ziyanzha/MOM_within_gene/MCREML_pooled_matfree/Phenotype/y_{tag}/rep{rep}.csv"
...
# this INCLUDES the matrix-free setup, which is part of the estimator's cost
...
output_dir = f"/home/ziyanzha/MOM_within_gene/MCREML_pooled_matfree/result/{mode}_s2gxg{s2gxg}_s2e{s2e}_n{n}m{m}_G{G}"
...
time_dir = f"/home/ziyanzha/MOM_within_gene/MCREML_pooled_matfree/time/rep_times/{mode}_s2gxg{s2gxg}_s2e{s2e}_n{n}m{m}_G{G}"
