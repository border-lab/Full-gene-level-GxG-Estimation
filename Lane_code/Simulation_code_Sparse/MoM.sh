...
python3 /home/ziyanzha/MOM_within_gene/Sparse_model/Simulate_MoM.py --n 1000 --m 1000 --s2gxg 0.9 --s2e 0.1 --mode Random --density 0.02 --nmc 100 --sparseVersion SNP --rep $SLURM_ARRAY_TASK_ID 
