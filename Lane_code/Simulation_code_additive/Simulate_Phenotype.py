...
save_path_s2a = f"{save_dir_s2a}/La_{mode}_n{n}_m{m}_s2gxg{s2gxg}_s2e{s2e}_s2a{s2a}.npy"
La = np.load(save_path_s2a)

Z, y = simulate_remove_sampling_err(SNP, Lgxg, La, s2a,s2gxg,s2e)

output_dir = f"/home/ziyanzha/MOM_within_gene/Whole_model/Phenotype/y_{mode}_n{n}_m{m}_s2gxg{s2gxg}_s2e{s2e}_s2a{s2a}"
