...
# -- not on s2gxg, s2e, or any phenotype draw -- so this job takes neither and
# runs once per (mode, n, m, G).  rho_g(r) ~ 1 means r is already big enough
...
out_dir = "/home/ziyanzha/MOM_within_gene/MCREML_pooled_matfree_Lowrank_Wu_unstd/result/variance_explained"
