...
W = np.load(f"/home/ziyanzha/MOM_within_gene/stored_genotype/W_{mode}_n{n}_m{m}.npy")

# Load phenotype (s2gxg_s2e order)
tag = f"{mode}_s2gxg{s2gxg}_s2e{s2e}_n{n}_m{m}"
y_path = f"/home/ziyanzha/MOM_within_gene/MCREML_gxg/Phenotype/y_{tag}/rep{rep}.csv"
...
output_dir = f"/home/ziyanzha/MOM_within_gene/MCREML_gxg/result/{mode}_s2gxg{s2gxg}_s2e{s2e}_n{n}m{m}"
...
time_dir = f"/home/ziyanzha/MOM_within_gene/MCREML_gxg/time/rep_times/{mode}_s2gxg{s2gxg}_s2e{s2e}_n{n}m{m}"
