...
# plus the epistasis GRM W itself.  W is deterministic per genotype, so it is
# PRE-COMPUTED and cached once under stored_genotype; the estimation step loads
# that cached dense W and applies it as a plain W @ b mat-vec.
...
save_dir = "/home/ziyanzha/MOM_within_gene/MCREML_gxg/Cholesky"
...
w_path = f"{w_dir}/W_{mode}_n{n}_m{m}.npy"
...
w_time_dir = "/home/ziyanzha/MOM_within_gene/MCREML_gxg/time/result"
