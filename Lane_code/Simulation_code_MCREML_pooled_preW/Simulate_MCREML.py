...
# Load the PRE-COMPUTED pooled epistasis GRM W (cached once by the Cholesky
# step) and apply it as a dense W @ b mat-vec inside MC AI-REML -- no genotype
# needed here.
W = np.load(f"/home/ziyanzha/MOM_within_gene/stored_genotype/W_{mode}_n{n}_m{m}_{split}.npy")
...
output_dir = f"/home/ziyanzha/MOM_within_gene/MCREML_pooled_preW/result/{mode}_s2gxg{s2gxg}_s2e{s2e}_n{n}m{m}_{split}"
...
time_dir = f"/home/ziyanzha/MOM_within_gene/MCREML_pooled_preW/time/rep_times/{mode}_s2gxg{s2gxg}_s2e{s2e}_n{n}m{m}_{split}"
